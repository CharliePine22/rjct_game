...
class Player(pg.sprite.Sprite):
    ...
    def __init__(self, game, x, y):
        ...
        self.dialog_box.set_portrait('RJCT_RYAN.png', size=(16, 16))
        self.conversation = [self.dialog_box]
        self.dialog_list = pg.sprite.LayeredDirty()
    ...
    def update(self):
        ...
        if hits:
            self.dialog_list.add(self.conversation[0])
            self.dialog_list.update()
            current_dialog = self.dialog_list.draw(self.game.screen)
...
class NPC(pg.sprite.Sprite):
    def __init__(self, game, x, y, image, waypoints):
